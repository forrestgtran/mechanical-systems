...
V1i =  [0, 0]                               ;
m2  =  1.8986e27                            ;%mass of Jupiter (kg)
P2i =  [778500000000, 0]                    ;%planet location vector
V2i =  [0, 13100]                           ;%orbital velocity of jupiter (m/s)
...
%% functions
    function res = jupitergoesvroom (~, W)
        %putting an O in front of these values so they don't interfere with
        %initial values
        P1 = [W(1), W(2)];
    ...
    function res = acceleration (P1, P2)
        ...
        fx = gravitational_force(1);
        fy = gravitational_force(2);
        
        xacceleration1 = fx/m1;
        yacceleration1 = fy/m1;
        xacceleration2 = fx/m2;
        yacceleration2 = fy/m2;
    ...
    function res = gravity_force_func (m1, P1, m2, P2)
