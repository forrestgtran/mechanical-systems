...
P1i =  [-4.6e10, 0 ]                  ;%star location vector
V1i =  [-100, 58980]                  ;%initial orbital velocity of mercury (m/s)

% venus
m2  =  4.87e24               ;%mass of body venus (kg)
P2i =  [-1.075e11, 0]       ;%planet location vector
V2i =  [0, 35260]              ;%initial orbital velocity of venus (m/s)

% earth
m3  =  5.976e24              ;%mass of body 3 (kg)
P3i =  [-1.471e11, 0]       ;%planet location vector
V3i =  [0, 30280]              ;%initial orbital velocity of star 3 (m/s)

% mars
m4  =  6.42e23               ;%mass of body 3 (kg)
P4i =  [-2.067e11, 0]       ;%planet location vector
V4i =  [0, 26500]              ;%initial orbital velocity of star 3 (m/s)

% jupiter
m5  =  1.8986e27               ;%mass of body 3 (kg)
P5i =  [-7.409e11, 0]       ;%planet location vector
V5i =  [0, 13720]              ;%initial orbital velocity of star 3 (m/s)

% saturn
m6 =  568.36e24                      ;%mass (kg)
P6i = [-1.352e12, 0]                ;%planet location vector (m)
V6i = [0 , 10180]                ;%initial orbital velocity (m/s)

% Uranus
m7 =  86.816e24                      ;%mass (kg)
P7i = [-2.7413e12, 0]                ;%planet location vector (m)
V7i = [0 , 7110]                ;%initial orbital velocity (m/s)

% Neptune
m8 =  102.42e24                      ;%mass (kg)
P8i = [ -4.44445e12, 0]                ;%planet location vector (m)
V8i = [0 , 5500]                ;%initial orbital velocity (m/s)
...
step = tseconds/1000;
time_span = [0 :step: tseconds]; %(0 : step : tseconds);
